# -*- coding: utf-8 -*-
"""
Created on Tue May  4 08:58:06 2021
...
# Chèn 6. Vì vậy, danh sách trở thành 6-> None
llist.append(6) 
  
# Chèn 7 ở đầu. 
# Vì vậy, danh sách được liên kết trở thành 7-> 6->None 
llist.push(7) 
  
# Chèn 1 ở đầu.
# Vì vậy, danh sách được liên kết trở thành 1-> 7-> 6->None 
llist.push(1) 
  
# Chèn 4 ở cuối.
# Vì vậy, danh sách được liên kết trở thành 1-> 7-> 6-> 4->None 
llist.append(4) 
  
# Chèn 8, sau 7.
# Vì vậy, danh sách được liên kết trở thành 1-> 7-> 8-> 6-> 4->None 
